...
Design rationale, the full field inventory, and the reasoning behind the rejected
alternatives are in the fork on `master`, at `plans/001-prompt-log-capture.md`.
The overlay's own manifest is `overlays/prompt-log-capture/README.md`.
